...
//{
//	{
//		int num = 0;//报错：num未声明的标识符
//	}
//	
//	printf("%d\n", num);//程序不能运行，说明num的作用域在所在的{ }里可以使用
//	//即num的作用域在主函数{ }内的{ }内
//	return 0;
//}
//#include <stdio.h>
...
//①在add.c文件中添加“int g_val = 2022;”在其他文件中（打印）使用变量g_val。此时报错：“g_val”：未声明的标识符
...
//#include <stdio.h>
////extern声明外部符号
//extern int g_val;//调用add.c文件（外部）的变量须声明变量
//int main()
//{
...
//	{//进入局部范围生命开始
//		int a = 10;//局部变量
//		printf("%d\n", a);//局部变量的生命周期是进入局部范围生命开始，出局部范围生命结束
//	}//出局部范围生命结束
//	//printf("%d\n", a);//报错，变量a出局部范围生命结束
//	 
//	return 0;
