...
//3、#define定义的标识符常量
//#include <stdio.h>
//#define Max 10000//结尾没有分号，此行须放在主函数外，不能放在#include <stdio.h>前
//int main()
//{
//	//Max = 2000;//报错：不能修改
//	int n = Max;
...
//int main()
//{
//	int arr[Max];//警告：“arr”未引用的局部变量，将arr[Max]初始化，如int arr[Max] = {0};
//	//说明：Max是常量
//	return 0;
//}
...
{//把性别的可能取值一一列举出来
	...
	FEMALE,
	SECRET
	//这些是枚举常量，是这种枚举类型（类型为enum Sex）的变量（如：s）的未来可能的取值
};//结尾要分号
int main()
{
