...
//	//计算机中的存放：0x00 00 00 14
//	//F10执行到通过return 0;调试-窗口-内存：观察&a，发现存放的是14 00 00 00
//	int b = -10;
//	//10000000 00000000 00000000 00001010 - 原码
//	//11111111 11111111 11111111 11110101 - 反码
//	//11111111 11111111 11111111 11110110 - 补码
//	//计算机中的存放：0xFF FF FF F6
//	//F10执行到通过return 0;调试-窗口-内存：观察&a，发现存放的是F6 FF FF FF 
//	return 0;
//}
...
//{
//	int a = 1;
//	//计算机存放1的形式：0x 00 00 00 01
//	//					   低地址-高地址
//	//小端计算机存储的方式：01 00 00 00
//	//大端计算机存储的方式：00 00 00 01
//	char* p = (char*) &a;//由于p是存放地址的，故可以存放的下a的地址，通过char*类型的解引用，跳过一个字节
//	//强制类型转换，否则会报警告
//  if (*p == 1)
//		printf("小端\n");
//	else
...
//{
//	int a = 1;
//	char* p = (char*)&a;//强制类型转换，值是不会发生变化的
//	return *p;
//}
////3、
//int check_sys()
...
//    //各变量中的补码：
//    //a：11111111 11111111 11111111 11111111//符号位为1高位补1
//    //b：11111111 11111111 11111111 11111111//符号位为1高位补1
//    //c：00000000 00000000 00000000 11111111//高位补0
//    //打印的是原码为：-1、-1、255
//    return 0;
//}
//2.输出什么？
...
//    //11111111 11111111 11111111 10000000//符号位为1高位补1
//    //打印的是原码为：4292967168
//    return 0;
//}
//对于char类型1个字节在内存的范围：
//  补码      有符号数char    无符号数char
//00000000      0               0
//00000001      1               1
//00000010      2               2
//...           ...             ...
...
//11111110      -2              254
//11111111      -1              255
//注意-128的原码、补码相同。127+1 = -128，-128-1= 127
...
//打印1111111 1111111 1111111 1111111 = 4292967295
...
//    return 0;
//}
//将a[1000]的所有元素转化-128~127中的数字，寻找0（即：\0-转换成ASCII码）
//7.输出什么？
//#include <stdio.h>
...
//浮点数表示的范围：float.h中定义
//char、short、int、long的表示范围：limits.h中定义
...
//如果E为8位，它的取值范围为0~255；如果E为11位，它的取值范围为0~2047。但是，科学计数法中的E是可以出现负数的，
...
//    //S = 0
//    //M = 1.011(只存储011)
//    //E = 2 = 10(存储2 + 127 = 10000001) 
//    //计算机中的存储形式：0 10000001 01100000000000000000000 = 0x 40 b0 00 00 00，由此可见也是小端字节序
//    //注意：小数部分补零是在后面补0
//    return 0;
//}
...
//E全为0
//这时，浮点数的指数E就等于1 - 127（或者1 - 1023）即为真实值，
