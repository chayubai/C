...
{
	member - list;                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           
}[variable - list];//[variable - list]可省略，该变量是struct tag类型定义的全局变量
*/
//分号不能丢
...
struct Stu
{
	...
	char tel[12];
	char sex[5];
}s1, s2, s3;//创建结构体类型的同时创建该结构体类型的变量，s1,s2,s3是三个全局的结构体变量
int main()
{
	//创建局部的结构体变量
	struct Stu s;
...
typedef struct Stu
{
	...
	char tel[12];
	char sex[5];
}Stu;//将结构体类型struct Stu 类型重定义为Stu
int main()
{
	//创建局部的结构体变量
	struct Stu s1;
...
struct T
{
	...
	//struct S* ps;//其他结构体类型的指针变量
	//struct T* pt;//结构体类型的指针变量
	char* pc;
