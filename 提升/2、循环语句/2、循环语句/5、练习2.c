...
/*12、写代码将三个数按从大到小输出*/
//思路：两两比较，找到较大值，再在较小值中比较，确定次小值和最小值
//#include <stdio.h>
//int main()
//{
//	int a = 0;
...
//先找出其中的较小值，除以这两个数，如果不能同时整除这俩个数，则依次减减，再是否整除，直到整除，
...
//先找出其中的较大值，然后被这两个数除以，如果不能同时被这两个数整除，则依次加加，再是否整除，直到整除，
